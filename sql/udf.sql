...
create or replace pynlp set script UDF.review_abs(review_id int, review_text varchar(200000)) emits (review_id int, sentence varchar(200000), aspect varchar(100), sentiment double) as
